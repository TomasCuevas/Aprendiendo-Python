"""
    ...
    # RANDINT(min, max): 
        devuelve un integer entre dos valores dados (ambos límites incluidos)
    # UNIFORM(min, max): 
        devuelve unfloat entre un valor mínimo y uno máximo
    # RANDOM(sin parámetros): 
        devuelve un float entre 0 y 1
    # CHOICE(secuencia): 
        devuelve une lemento al azar de una secuencia de valores(listas, tuples, rangos, etc.)
    # SHUFFLE(secuencia): 
        toma una secuencia de valores mutable (como una lista), y la retorna cambiando el orden de sus elementos aleatoriamente. 
"""
